...
from data_parser.models.neighbourhood_crime_rates import json_to_NeighbourhoodCrimeRates
from data_parser.models.neighbourhoods import json_to_Neighbourhoods
...
class TestNeighbourhoods(TestCase):
    def test_json_to_Neighbourhoods(self):
        ...
        with open(os.path.join(os.path.dirname(__file__), data_path), "r") as file:
            ...
            self.assertEqual(documents[0]['data_id'], 25)
...
class TestNeighbourhoodCrimeRates(TestCase):
    def test_json_to_NeighbourhoodCrimeRates(self):
        ...
        with open(os.path.join(os.path.dirname(__file__), data_path), "r") as file:
            ...
            self.assertEqual(documents[0]['data_id'], 1)
